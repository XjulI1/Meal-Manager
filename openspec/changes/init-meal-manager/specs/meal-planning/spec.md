# Delta for Meal Planning

Bounded context gérant le **menu hebdomadaire** : une grille de 7 jours × 3 repas (petit-déjeuner, déjeuner, dîner) à laquelle on associe des recettes du catalogue.
